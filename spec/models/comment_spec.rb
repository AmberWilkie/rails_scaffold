...
RSpec.describe Comment, type: :model do
  ...
  describe 'Additional validations' do
    ...
    it 'should take a really long body' do
      expect(FactoryGirl.create(:comment, article_id: @factory_article.id, body: "What is Lorem Ipsum?
        ...
        The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from de Finibus Bonorum et Malorumby Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.")).to be_valid
    end
  end
end
